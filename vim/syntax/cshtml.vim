" Vim syntax file
" Language:	Razor
" Maintainer:	David Mohundro <david@mohundro.com>
" URL:		http://mohundro.ocm
" Last Change:  2011 Nov 4
" Notes: Based on the html.vim that ships with vim
...
if main_syntax != 'java' || exists("java_javascript")
  ...
  syn region  javaScript start=+<script[^>]*>+ keepend end=+</script>+me=s-1 contains=@htmlJavaScript,htmlCssStyleComment,razorComment,htmlScriptTag,@htmlPreproc
...
if version >= 508 || !exists("did_html_syn_inits")
  ...
  HtmlHiLink razorComment Comment
endif
